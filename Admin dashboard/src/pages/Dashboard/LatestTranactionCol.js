...
export const EmailCol = (cell) => (
  <span className="text-muted">{cell.value}</span>
);
export const DateCol = (cell) => (
  <span className="text-muted">
    {cell.value ? moment(cell.value).format('DD MMM YYYY') : 'N/A'}
  </span>
);
export const BadgeText = (cell) => (
  <span className="badge badge-soft-primary font-size-11">{cell.value}</span>
);
