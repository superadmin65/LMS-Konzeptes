        ...
        switch (type) {
          ...
          case "visual_audio": {
            const dataJsonObj = {
              ...
              questions: values.questions.map((q) => {
                return {
                  qText: q.question.trim(),
                  options: q.answers, // Array of URLs
            ...
            apiPayload = {
              ...basePayload,
              type: "visualInformationProcessing", // <-- NEW DB TYPE
          ...
          case "clickanddrag": {
            const formattedRows = values.clickAndDragRows
              .filter((r) => r.word.trim() !== "") // Skip empty rows
              .map((r, idx) => ({
                id: `row${idx}`,
                word: r.word,
                audioSrc: r.audioSrc,
            ...
            apiPayload = {
              ...basePayload,
              type: "clickAndDrag", // Saves as clickAndDrag in the database
  ...
  useEffect(() => {
    if (isEdit && editData) {
      ...
      if (parsedData) {
        ...
        let recVisualAudioImage = null; // <-- NEW HOLDER
        let recMCQ = null;
        ...
        // --- NEW VISUAL PARSING (Keeps arrays intact) ---
        if (
          parsedData &&
        ...
        validation.setValues({
          ...
          questions:
            activityType === "mcq"
              ...
              : activityType === "visual_audio" ||
                activityType === "visual_image"
              ? recVisualAudioImage // <-- MAPPED HERE
              : recMatch,
        ...
        <Form onSubmit={validation.handleSubmit}>
              ...
              <Row>
                ...
                <Col md={3}>
                  ...
                  >
                    ...
                    {/* NEW OPTIONS MAPPED HERE */}
                    <option value="visual_audio">
                      Visual Info Processing (Audio)
                    </option>
                    <option value="visual_image">
                      Visual Info Processing (Image)
                    </option>
          ...
          <Card className="mb-3">
            ...
            >
              ...
              {/* NEW VISUAL COMPONENT RENDERED HERE */}
